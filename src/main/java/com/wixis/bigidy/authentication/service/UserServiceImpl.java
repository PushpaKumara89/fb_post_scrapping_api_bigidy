...
import com.wixis.bigidy.authentication.repo.RoleRepo;
import com.wixis.bigidy.authentication.repo.UserRepo;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public User saveUser(User user) {
        if(userRepo.findByUsername(user.getUsername()) == null){
            ...
            log.error("user {} already exists in the database", user.getName());
            return null;
        }
    }
